...
void QSingleApplication::_newLocalConnection()
 ...
 void QSingleApplication::_initLocalConnection()
 {
    ...
    qDebug()<<" _initLocalConnection _serverName:"<<_serverName;
 ...
 void QSingleApplication::_newLocalServer()
 {
     ...
     qDebug()<<" _newLocalServer _serverName:"<<_serverName;
...
void QSingleApplication::_closeLocalServer()
{
    if( _localServer )
        _localServer->close();
}
